...
export default function SilkCribSheetPage() {
    ...
    <>
      ...
      <div className="relative h-[400px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-3xl px-4">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Silk Crib Sheet</h1>
      ...
      <div className="container mx-auto px-4 py-4">
        <ProductsBreadcrumb items={[
          ...
          { label: 'Wholesale Silk Crib Sheet', isCurrent: true },
        ]} />
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-600 text-center">
            Our premium silk crib sheet collection will be available soon. 
